package net.s0baco.desert.renderer;
...
{
	private TileEntitySandstoneChest tileentity = new TileEntitySandstoneChest(0);
...
//		 this.renderChest(block, metadata, modelId);
		 TileEntityRendererDispatcher.instance.renderTileEntityAt(this.tileentity, 0.0D, 0.0D, 0.0D, 0.0F);
	...
	private static final ResourceLocation field_147505_d = new ResourceLocation("desertexpansion:textures/models/chest_sandstone_double.png");
	...
	private static final ResourceLocation field_147504_g = new ResourceLocation("desertexpansion:textures/models/chest_sandstone.png");
